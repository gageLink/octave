...
public:
    ...
    Camera3D* GetScreenCamera(uint32_t screen);

    void SetActiveCamera(Camera3D* activeCamera, uint32_t screen = 0);
...
private:
    ...
    bool WorldSeen();
    void FillBlankScreen(Camera3D* camera);
...
private:
    ...
    std::vector<class Camera3D*> mScreenCamera;
