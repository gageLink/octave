...
void GFX_BeginView(uint32_t viewIndex)
{
    ...
    if (gC3dContext.mCurrentScreen == 0)
    {
        ...
        Camera3D* camera = gC3dContext.mWorld->GetActiveCamera(Renderer::Get()->GetCurrentScreen());
        if (camera != nullptr)
        {
...
void GFX_DrawStaticMeshComp(StaticMesh3D* staticMeshComp, StaticMesh* meshOverride)
{
    ...
    if (mesh != nullptr)
    {
        ...
        glm::mat4 viewSrc = gC3dContext.mWorld->GetActiveCamera(Renderer::Get()->GetCurrentScreen())->GetViewMatrix();
        ...
        C3D_Mtx projMtx;
        glm::mat4 projSrc = gC3dContext.mWorld->GetActiveCamera(Renderer::Get()->GetCurrentScreen())->GetProjectionMatrix();
