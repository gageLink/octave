...
{
    Camera3D* camera = world->GetActiveCamera(Renderer::Get()->GetCurrentScreen());
...
{
    Camera3D* camera = instancedMeshComp->GetWorld()->GetActiveCamera(Renderer::Get()->GetCurrentScreen());
